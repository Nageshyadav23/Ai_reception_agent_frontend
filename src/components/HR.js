  ...
  const fetchHistory = async () => {
    try {
      ...
      if (Array.isArray(data)) {
        const hrCalls = data
          .filter((call) => call.intent.toLowerCase() === "hr")
...
const handleToggleStatus = async (callId, currentStatus) => {
  ...
  // If marking pending, reset reply to empty string
  ...
  return (
    ...
    >
      ...
      >
        {history.length === 0 && <p>No HR calls found.</p>}
        {history.map((call) => (
          <div
            key={call.id}
            style={{
              ...
              borderRadius: "8px",
              backgroundColor:
                call.status === "completed" ? "#155724" : "#004085", // green or blue
              color: "#fff",
              transition: "all 0.4s",
            ...
            <p>
              ...
              <button
                ...
                style={{
                  ...
                  border: "none",
                  backgroundColor:
                    call.status === "completed" ? "#dc3545" : "#28a745", // toggle color
                  color: "#fff",
                  fontWeight: 600,
                  cursor: "pointer",
                  transition: "all 0.3s",
